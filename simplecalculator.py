...
text3=tk.Label(root,text="operation : ",fg="blue",bg="green",height=5)
...
btn=tk.Button(root,command=my_func,text="equals",height=5,fg="purple",bg="pink",activebackground="yellow",activeforeground="black")
btn.grid(row=3,column=2)

text4=tk.Label(root,fg="white",bg="orange",height=3,width=15)
